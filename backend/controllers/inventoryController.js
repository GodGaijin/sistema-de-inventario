...
class InventoryController {
    ...
    static async approveRequest(req, res) {
        try {
            ...
            const approvedRequest = await InventoryRequestModel.approveRequest(requestId, adminId);
            ...
            const transactionData = {
                ...
                codigo_prod: product.codigo_seniat,
            ...
            // Registrar auditoría de transacción creada
            await logAudit(
                adminId,
                req.user.username,
                'CREATE',
    ...
    static async rejectRequest(req, res) {
        try {
            ...
            const rejectedRequest = await InventoryRequestModel.rejectRequest(requestId, adminId, rejection_reason);
